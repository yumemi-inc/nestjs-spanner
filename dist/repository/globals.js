...
const meta_data_args_storage_1 = require("./meta-data/meta-data-args-storage");
/**
...
function getMetadataArgsStorage() {
    ...
    if (!globalScope.ormMetadataArgsStorage)
        globalScope.ormMetadataArgsStorage = new meta_data_args_storage_1.MetaDataArgsStorage();
